...
export default async function handler(req, res) {
  ...
  try {
    ...
    const prompt = `
      ...
      If the Match Format is "grass" or "indoor", you are STRICTLY PROHIBITED from referencing "sand", "beach", "sand footing", or beach tactics anywhere in your response. Ensure all paragraphs (offensive, defensive, tactical briefs) maintain absolute consistency, utilizing strictly grass-specific mechanical terms (e.g., hard pivots, stable turf footing, turf-burns, spikes, cleats, grass). 
      If the Match Format is "beach" or "sand", you are STRICTLY PROHIBITED from referencing grass-specific terms like "turf", "grass", "spikes", or "cleats". Ensure all paragraphs maintain absolute consistency, utilizing strictly beach-specific mechanical terms (e.g., sand footing, sand dunes, wind-handling, low-release throws, sand).
