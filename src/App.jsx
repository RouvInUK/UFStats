    ...
    <div onClick={unlockAudio} onTouchStart={unlockAudio} className="min-h-screen bg-slate-900 selection:bg-indigo-500 selection:text-white pb-24">
      ...
      <div className="hidden sm:flex justify-between items-center px-8 py-4 bg-slate-950/80 backdrop-blur-md border-b border-white/5 sticky top-0 z-40 shadow-xl">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => setCurrentView(isAdminAndNoShadow ? 'admin' : 'dashboard')}>
      ...
      <div className="sm:hidden flex flex-col px-4 py-3 bg-slate-950/90 backdrop-blur-md border-b border-white/5 sticky top-0 z-40 shadow-md gap-2">
        <div className="flex justify-between items-center w-full">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => setCurrentView(isAdminAndNoShadow ? 'admin' : 'dashboard')}>
